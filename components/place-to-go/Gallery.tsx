...
const Gallery = () => {
  ...
  return (
    <>
      <div style={{height: 70, overflow: 'hidden', width: '100%', zIndex:'10', transform: 'translateY(65px)'}} ><svg viewBox="0 0 500 150" preserveAspectRatio="none" style={{height: '100%', width:'100%'}}><path d="M-27.93,7.42 C149.99,150.00 271.49,-49.98 500.00,49.98 L500.00,0.00 L0.00,0.00 Z" style={{ stroke: 'none', fill: '#fff'}}></path></svg></div>  
