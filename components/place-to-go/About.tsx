  ...
  return (
    <div>
      ...
      <div className={styles.About} id='about'>
        <h2 className={styles.AboutH2}>Descubrí las <strong>Actividades</strong> que podes realizar en este <strong>Free Tour</strong></h2>
        ...
        <div className='titleSection'style={{ marginTop: '2rem' }} ref={refValue} >
            <h1>INFORMACIÓN ÚTIL</h1>
            <hr />
        </div>
        <div className={`${styles.AboutGrid} ${gridVisible ? styles.AboutGridAnimate : ''}`}>
