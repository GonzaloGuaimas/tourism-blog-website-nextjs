...
const AwardDialog = ({ showAwardDialog, hideAwardDialog, setAwards, tourName, toast } : { showAwardDialog: boolean, hideAwardDialog: any, setAwards: any, tourName: string, toast: any }) => {
    const { submitted, loading, image, awardItem, onInputChange, handleOnChange, submitForm  } = useNewAward(setAwards, tourName, hideAwardDialog, toast)
  return (
